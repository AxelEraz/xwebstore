    ...
    <body>
         ...
         <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand text-white" href="#" width="180" height="80">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">SEVICIOS</a>
                    </li>
      ...
      <br>
         ...
         @if (Route::has('login'))
            @auth
            <a href="{{ url('/dashboard') }}" id="" class="btn btn-primary mx-2" href="#" role="button">Panel de control</a>
           @else
                    <a href="{{ route('login') }}" id="" class="btn btn-primary mx-2" href="#" role="button">Inicia sesión</a>
           
           @if (Route::has('register'))
                    <a href="{{ route('register') }}" id="" class="btn btn-success mx-2" href="#" role="button">Registrate</a>
             @endif
