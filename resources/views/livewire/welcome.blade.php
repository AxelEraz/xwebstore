<div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 items-center py-10 mt-20 dark:bg-slate-600">
        ...
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mx-auto py-5 px-5">
            ...
            <div class="p-5">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100 text-center">Shop</h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-300">Te brindamos un espacio sin costo tus productos o servicios en nuestra tienda online.</p>
        ...
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mx-auto py-5 px-5">
            ...
            <div class="p-5">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100 text-center">X-list</h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-300">Si tenes una distrbuidora o sos proveedor de insumos necesitas probar esta herramienta con tus clientes!</p>
                <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Probar ahora!
                    <svg aria-hidden="true" class="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </a>
        ...
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mx-auto py-5 px-5">
            ...
            <div class="p-5">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100 text-center">Redes sociales</h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-300">Contenido gratis para llevar a otro nivel las redes de tu negocio con prácticas profesionales!</p>
                <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Iniciar curso!
                    <svg aria-hidden="true" class="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </a>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 items-center mt-20 mb-10">
        ...
        <div class="text-center mx-auto">
            ...
            <span class="text-blue-600 dark:text-blue-500">CONOCÉ </span>NUESTROS SERVICIOS WEB PROFESIONALES Y LLEVA AL LIMITE TUS GANANCIAS</h5>       
        </div>
